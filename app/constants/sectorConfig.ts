/**
 * Sector configuration for dynamic product fields
 * Centralized to avoid duplication and support future modifications
 */

export const sectorConfig: Record<string, any[]> = {
    // Sector: Services (Workshop, Beauty, Consulting)
    services: [
    ...
    // Sector: Retail (Store, Bazaar, Supermarket)
    retail: [
    ...
    // Sector: Gastronomy (Restaurant, Diner)
    gastronomy: [
