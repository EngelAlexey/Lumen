export const useOptions = () => {
  ...
  const roleOptions = computed(() => [{ label: t('roles.all'), value: 'all' }, ...roles.value])
  ...
  const paymentMethodOptions = computed(() => [
    ...
    {
      label: t('status.payment_method.card_manual'),
      value: 'card_manual',
      icon: 'i-heroicons-credit-card'
    },
    {
      label: t('status.payment_method.transfer'),
      value: 'transfer',
      icon: 'i-heroicons-arrow-path'
    },
    {
      label: t('status.payment_method.stripe_checkout'),
      value: 'stripe_checkout',
      icon: 'i-heroicons-globe-alt'
    },
    {
      label: t('status.payment_method.other'),
      value: 'other',
